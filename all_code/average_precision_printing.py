...
img_id = '006329'
vehicle = cv2.imread(f'/home/nirbhayborikar/Documents/RWU/CV/project/KITTI_Selection/images/{img_id}.png')
ground_truth_file = f'/home/nirbhayborikar/Documents/RWU/CV/project/KITTI_Selection/labels/{img_id}.txt'
output_path = f'/home/nirbhayborikar/Documents/RWU/CV/project/KITTI_Selection/Output images/Averageprecision/{img_id}_AP.png'
...
print("no_of_ground_truth_box",len(ground_truth_boxes))
print("no_of_detected_box",len(detected_boxes))
...
cvzone.putTextRect(
    vehicle, 
    f'Average Precision: {AP:.4f}',  # Display AP with four decimal places changed from 4to 2 decimal
